...
#define ADC_CONVERTED_DATA_BUFFER_SIZE   3UL   /* Size of array aADCxConvertedData[] */
/* USER CODE END PM */
...
int main(void) {
	...
	while (1) {
		...
		mVoltagePot1 = ADC_RES[1] * ((float) ADC_REFERNCE / ADC_MAX);
		/*read the internal voltage that is connected to VDDA*/
